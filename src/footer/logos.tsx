...
export default function Logos() {
  return (
    <div className="logos">
      ...
      >
        <div>
          <img src="./images/ChristianDior.png" alt="Logos" />
        </div>
        <div>
